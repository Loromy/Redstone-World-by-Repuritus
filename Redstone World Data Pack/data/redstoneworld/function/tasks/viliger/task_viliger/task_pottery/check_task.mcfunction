...
execute as @e[type=minecraft:interaction,tag=rw_task_pottery_interaction] on target at @s run execute if score @s task_pottery matches 11 run function redstoneworld:tasks/viliger/task_viliger/show_completed
