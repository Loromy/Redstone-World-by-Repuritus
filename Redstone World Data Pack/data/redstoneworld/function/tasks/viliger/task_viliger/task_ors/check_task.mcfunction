...
execute as @e[type=minecraft:interaction,tag=rw_task_ores_interaction] on target at @s run execute if score @s task_ores matches 9 run function redstoneworld:tasks/viliger/task_viliger/show_completed
