loot give @s loot redstoneworld:redstoneworld/loot_bag/bag_uncommon_loot
...
clear @s minecraft:warped_fungus_on_a_stick[item_model="minecraft:green_bundle",custom_data={ability:12}] 1
