...
execute if score @s cw_ability matches 3 run execute unless score @s Mana matches 100.. run tellraw @s [{"bold":true,"color":"light_purple","italic":false,"text":"You don't have enough mana: "},{"score":{"name":"@s","objective":"Mana"}},{"text":"/100"}]
