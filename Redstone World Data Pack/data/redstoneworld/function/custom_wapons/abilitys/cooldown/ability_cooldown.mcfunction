scoreboard players remove @s[scores={wapon_cooldown_fire=1..}] wapon_cooldown_fire 1
scoreboard players remove @s[scores={wapon_cooldown_speed=1..}] wapon_cooldown_speed 1
