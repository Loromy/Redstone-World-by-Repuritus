...
execute as @e[type=minecraft:interaction,tag=rw_task_forge_interaction] on target at @s run execute if score @s task_forge matches 9 run function redstoneworld:adventur_system/tasks/viliger/task_viliger/show_completed
