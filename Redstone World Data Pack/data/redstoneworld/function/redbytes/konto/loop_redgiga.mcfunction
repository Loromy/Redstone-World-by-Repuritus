# ========================================================
# SCHLEIFEN-FUNKTION: REDGIGAS IN 64er STACKS SPLITTEN
# Pfad: data/redstoneworld/function/redbytes/konto/loop_redgiga.mcfunction
# ========================================================

# 1. Einen perfekten, erlaubten 64er Stack ausgeben
function redstoneworld:redbytes/give_redgiga with storage redstoneworld:ram stack_64
